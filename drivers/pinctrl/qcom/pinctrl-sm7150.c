...
static const struct msm_pingroup sm7150_groups[] = {
	...
	[124] = SDC_QDSD_PINGROUP(sdc2_clk, SOUTH, 0x898000, 14, 6),
	[125] = SDC_QDSD_PINGROUP(sdc2_cmd, SOUTH, 0x898000, 11, 3),
	[126] = SDC_QDSD_PINGROUP(sdc2_data, SOUTH, 0x898000, 9, 0),
};
